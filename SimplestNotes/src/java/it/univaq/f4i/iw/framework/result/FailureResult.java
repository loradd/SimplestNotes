...
public class FailureResult {
    ...
    public FailureResult(ServletContext context) {
        ...
        this.context.setAttribute("error", "error.ftl.html");
    ...
    public void activate(String message, HttpServletRequest request, HttpServletResponse response) {
        try {
            System.err.println((String)context.getAttribute("error"));
            ...
            if ((String)context.getAttribute("error") != null) {
                request.setAttribute("error", message);
               // request.setAttribute("outline_tpl", "");
                template.activate((String)context.getAttribute("error"), request, response);
            } else {
